public class Week1 {
    ...
    System.out.print (not println) and produces the same output. */
        System.out.print("This is my First progam \nI am on module ST4003CEM");
    ...
    '' is not the same as " */
        System.out.print("A \"quoted\" String is 'much' better if you learn the rules of \"escape sequences.\" Also,\"\"represents an empty String.\n\n" );
    ...
    ********* */
    ...
    A System.out.println statement has ( and ) acnd usually a String that starts and ends with a " character.
 ...
 */
        ...
        System.out.println();
        System.out.println("One is what wee see when we're typing our program. The other is what appears on the \"console.\"");
    }
